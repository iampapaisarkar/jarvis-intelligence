...
def main() -> None:
    parser = argparse.ArgumentParser(description="Download a local GGUF model for Jarvis Phase 1")
    parser.add_argument(
        "--small",
        action="store_true",
